module.exports = {
    ...
    SETTINGS_GUILD_INVITE_NOT_SET: `No Server Invite has been set`,
    SETTINGS_GUILD_INVITE_VANITY_FOUND: `(Using Vanity Invite)`,
    // Panel
    ...
    SETTINGS_PANEL_GUILD_INVITE_DESCRIPTION: `### Server Invite to use\n{{0}}`,
    ...
    // Guild Invite
    SETTINGS_MODAL_GUILD_INVITE_TITLE: `Edit HomeCord: Server Invite`,
    SETTINGS_MODAL_GUILD_INVITE_DESCRIPTION: `Set the Server Invite link to display on this Server's page on HomeCord's website - so new members who find this Community via HomeCord can join this Server.\n\nThe Invite *must* be in the format of: \`https://discord.gg/example\` - replacing \`example\` with an actual invite code to your Server of course.`,
    SETTINGS_MODAL_GUILD_INVITE_LABEL: `Server Invite`,
    SETTINGS_GUILD_INVITE_ERROR_INVALID_INVITE: `Whoops, that was not a valid Discord Server invite link!\nPlease try again, making sure you set the invite setting to use an invite pointing to *this* Server, using the invite format of \`https://discord.gg/example\``,
    SETTINGS_GUILD_INVITE_ERROR_INVITE_NOT_FOR_A_GUILD: `Whoops, that Discord invite was not for this Server!\nPlease try again, making sure you set the invite setting to use an invite pointing to *this* Server, and not a Group DM or a Friend invite.`,
    SETTINGS_GUILD_INVITE_ERROR_INVITE_FOR_DIFFERENT_GUILD: `Whoops, that Discord Server invite was not pointing to this Server!\nPlease try again, making sure you set the invite setting to use an invite pointing to *this* Server.`,
    // Activity Thresholds
